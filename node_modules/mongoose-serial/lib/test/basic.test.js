...
var options = { field: 'serial', prefix: "Invoice", separator: "-", digits: 5, initCounter: "monthly", ignoreIncrementOnEdit: false };
...
describe('Mongoose-serial', function () {
    ...
    it('should not increment Invoices on edit operation', function (done) {
        ...
        invoiceSchema.plugin(plugin, options);
        var Invoice = connection.model('Invoice2', invoiceSchema);
        var invoice1 = new Invoice({ ht: 10000, ttc: 10010 });
        var invoice2 = new Invoice({ ht: 12000, ttc: 12010 });
        var invoice3 = new Invoice({ ht: 13000, ttc: 12010 });
        var invoice4 = new Invoice({ ht: 14000, ttc: 12010 });
        ...
        // assert
        function assertRecord(err, results) {
            should.not.exist(err);
            results.invoice1.should.have.property('ht', 10000);
            results.invoice2.should.have.property('ht', 12000);
            done();
        ...
        Invoice.findOne({ ht: 12000 })
            ...
            data.save().then(function () {
                Invoice.findOne({ ht: 15000 })
                    ...
                    chai_1.assert(serial === verifyData.serial, 'Edit operation should not increment invoice serial');
                })
