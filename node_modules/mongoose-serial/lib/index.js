...
var extractCounter = function (options, serial) {
    var separator = options.separator, initCounter = options.initCounter, _a = options.digits, digits = _a === void 0 ? 10 : _a, ignoreIncrementOnEdit = options.ignoreIncrementOnEdit;
    var counter;
    if (serial !== null) {
...
var plugin = function (schema, options) {
    var field = options.field, prefix = options.prefix, separator = options.separator, initCounter = options.initCounter, _a = options.ignoreIncrementOnEdit, ignoreIncrementOnEdit = _a === void 0 ? true : _a;
    var counter;
